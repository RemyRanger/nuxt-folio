        ...
        >
          <div class="header-nav-inner">
            ...
            <ul v-if="!hideSignin" class="list-reset header-nav-right">
              <li>
                <NuxtLink to="/signup/" class="button button-wide-mobile button-sm">
                  Sign up
                </NuxtLink>
              </li>
            </ul>
...
export default {
  ...
  methods: {
    openMenu () {
      ...
      if (this.$refs.nav) { this.$refs.nav.style.maxHeight = this.$refs.nav.scrollHeight + 'px' }
