      ...
      <div class="container-xs">
        ...
        <figure>
          ...
          <figcaption class="text-color-low">
            A super-nice image <span role="img" aria-label="smile">😀</span>
          </figcaption>
        </figure>
        <h4>Flexibility</h4>
        <p>
    ...
    <c-generic-section top-divider class="center-content">
      <div class="container">
        ...
        <c-button-group>
          ...
          <c-button color="secondary" wide-mobile>
            Get started now
          </c-button>
          <c-button color="dark" wide-mobile>
            Get started now
          </c-button>
        </c-button-group>
      </div>
      ...
      <div class="container-xs">
        ...
        <c-modal id="demo-modal" :active.sync="demoModalActive">
          ...
          <div class="center-content mt-24">
            <a
              class="button-link text-xxs tt-u"
              aria-label="close"
              href="#"
              @click.prevent="demoModalActive = false"
            >No thanks!</a>
          </div>
        </c-modal>
      </div>
...
// import sections
import CHeroFull from '@/components/sections/HeroFull02.vue'
