          ...
          <div class="tiles-item reveal-from-bottom">
            <div class="tiles-item-inner has-shadow">
              <div class="pricing-item-content">
                <div class="pricing-item-header pb-16 mb-24">
                  <div class="pricing-item-price">
                    <span class="pricing-item-price-currency h3 text-color-mid">{{ getPricingData(priceOutput.plan1, 0) }}</span>
                    <span class="pricing-item-price-amount h1">{{ getPricingData(priceOutput.plan1, 1) }}</span>
                    <span class="pricing-item-price-after text-sm">{{ getPricingData(priceOutput.plan1, 2) }}</span>
                  </div>
              ...
              <div class="pricing-item-cta mb-8">
                <c-button tag="a" color="secondary" wide href="#">
                  Start free trial
                </c-button>
              </div>
            </div>
          ...
          <div class="tiles-item reveal-from-bottom" data-reveal-delay="200">
            <div class="tiles-item-inner has-shadow">
              <div class="pricing-item-content">
                <div class="pricing-item-header pb-16 mb-24">
                  <div class="pricing-item-price">
                    <span class="pricing-item-price-currency h3 text-color-mid">{{ getPricingData(priceOutput.plan2, 0) }}</span>
                    <span class="pricing-item-price-amount h1">{{ getPricingData(priceOutput.plan2, 1) }}</span>
                    <span class="pricing-item-price-after text-sm">{{ getPricingData(priceOutput.plan2, 2) }}</span>
                  </div>
                  <div class="text-color-low text-xs mt-4 mb-4">
                    Lorem ipsum is a common text
                  </div>
          ...
          <div class="tiles-item reveal-from-bottom" data-reveal-delay="400">
            <div class="tiles-item-inner has-shadow">
              <div class="pricing-item-content">
                <div class="pricing-item-header pb-16 mb-24">
                  <div class="pricing-item-price">
                    <span class="pricing-item-price-currency h3 text-color-mid">{{ getPricingData(priceOutput.plan3, 0) }}</span>
                    <span class="pricing-item-price-amount h1">{{ getPricingData(priceOutput.plan3, 1) }}</span>
                    <span class="pricing-item-price-after text-sm">{{ getPricingData(priceOutput.plan3, 2) }}</span>
                  </div>
                  <div class="text-color-low text-xs mt-4 mb-4">
                    Lorem ipsum is a common text
                  </div>
