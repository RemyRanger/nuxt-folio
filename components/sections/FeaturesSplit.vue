      ...
      >
        ...
        >
          <div class="split-item">
            ...
            <div
              class="split-item-image illustration-element-01 reveal-from-bottom"
          ...
          <div class="split-item">
            ...
            <div
              class="split-item-image illustration-element-02 reveal-from-bottom"
              data-reveal-container=".split-item"
              data-reveal-delay="200"
              :class="imageFill && 'split-item-image-fill'"
            >
          ...
          <div class="split-item">
            ...
            <div
              class="split-item-image illustration-element-03 reveal-from-bottom"
              data-reveal-container=".split-item"
              data-reveal-delay="200"
              :class="imageFill && 'split-item-image-fill'"
            >
